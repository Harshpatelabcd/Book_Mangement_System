<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Kitabe2.EmailSending" %>
            ...
            <div class="card p-0">
                ...
                <div class="card-body">
                    ...
                    <div class="nav-item active">
                        <a class="nav-link" href="Registration.aspx">Sing Up <span class="sr-only">(current)</span></a>
                    </div>
                </div>
                    </form>
                </div>
