<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_Dashboard.aspx.cs" Inherits="Kitabe2.Book_Management" %>
    ...
    <div class="main-panel">
         ...
         <form id="form1" runat="server">
          ...
          <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                          <b><h5>Rating on each Book</h5></b>
             <p>Following pie chart indicates the rating on each by different users out of 5 stars.</p>
             <br />
 &nbsp; &nbsp;<asp:DropDownList ID="Book_Title" Width="150px" runat="server" OnSelectedIndexChanged="ddlCountries_SelectedIndexChanged"
    AutoPostBack="true"></asp:DropDownList><br /><br />
            <ajaxToolkit:PieChart ID="PieChart1" runat="server" 
                ChartHeight="400" ChartWidth = "400" ChartType="Column" ChartTitleColor="#0E426C" Visible = "True"></ajaxToolkit:PieChart>
             <br />
