<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Homepage.aspx.cs" Inherits="Kitabe2.Homepage" %>
      ...
      <div class="header-container d-flex align-items-center">
        ...
        <nav class="nav-menu d-none d-lg-block">
          <ul>
            ...
            <li class="get-started"><a href="Login1.aspx">Login</a></li>
          </ul>
        </nav><!-- .nav-menu -->
      ...
      <div class="container">
        ...
        <div class="row content">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left" data-aos-delay="200">
            <p>
              Give Rating and Review on the book and system will find the best book based on your choices.
